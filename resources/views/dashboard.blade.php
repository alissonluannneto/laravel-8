    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('unidade-medida.index')}}">Unidade de medida</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{route('nivel.index')}}">Nível de acesso</a>
          </li>

        </ul>
      </div>
      <a class="navbar-brand" href="#">{{auth()->user()->name}}</a>
      <a href="{{route('logout.perform')}}" class="btn btn-primary">Sair</a>
    </div>
  </nav>
</header>
